...
% 
% For convenience, the doku webpage is also part of the distribution of this demo. 
% 
...
global ALLDATA;
global SCDATA;
ALLDATA = struct('Dim'  , 2, 'MinDim'   , 2, 'MaxDim'    , 200, 'Num', 500, 'NumKNN', 10,  'MinKNN', 1, 'MaxKNN', 200, 'Eps', 0.3, 'MinEps', 0.01, 'MaxEps', 10.0, 'Density', 1, 'x',0, 'y', 0, 'Labeled', 0, 'GraphType', 1, 'K', 0, 'Gamma',1,'MaxGamma',10,'MinGamma',0.1);
...
% XXXX changed by ule in 2015: for weird reasons, the MenuData slider did not appear any more 
% in the demo. I re-inserted it and for some other weird reason, needed to change the follwoing two lines a bit, 
% compared to the previous version. 
tmp = get(handles.MenuData, 'Value');
popup_sel_index = tmp{2}; 
